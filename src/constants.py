...
# OpenSearch settings
OPENSEARCH_HOST = "http://192.168.4.36"  # Hostname for the OpenSearch instance
...
OLLAMA_HOST = os.getenv("OLLAMA_HOST", "http://192.168.4.112")
...
OPENSEARCH_HOST = os.getenv("OPENSEARCH_HOST", "http://192.168.4.36")
